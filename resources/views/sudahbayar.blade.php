...
@section('title', 'MVG - Transaksi Sudah Dibayar')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Transaksi Sudah Dibayar</h1>
    </div>
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Transaksi Sudah Dibayar</h6>
        </div>
        <div class="card-body">
...
<script>
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": false,
            ajax: {
                url: "{{route('datatransaksidibayar')}}",
                type: "GET",
                headers: {
